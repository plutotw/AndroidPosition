...
import com.example.androidposition.service.CreateImageServerImpl;
...
public class CourseController {
    ...
    @Resource
    private CreateImageServerImpl createImageServer;
    ...
    public void getImage(HttpServletResponse resp) throws IOException {
        ...
        BufferedImage image = createImageServer.getImage();
